...
int PhysicalDisplay::RegisterVsync_2_4Callback(
    std::shared_ptr<Vsync_2_4Callback> callback, uint32_t display_id) {
  return display_queue_->RegisterVsync_2_4Callback(callback, display_id);
}
